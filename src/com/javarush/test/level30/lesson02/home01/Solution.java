...
public class Solution {
    ...
    public static Number convertNumberToOtherNumerationSystem(Number number, NumerationSystem expectedNumerationSystem) {
        try
        {
            BigInteger bigDecimal = new BigInteger(""+number.getDigit(), number.getNumerationSystem().getNumerationSystemIntValue());
            return new Number(expectedNumerationSystem, bigDecimal.toString(expectedNumerationSystem.getNumerationSystemIntValue()));
        }
        catch (Throwable e){
