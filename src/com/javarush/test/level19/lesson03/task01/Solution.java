...
public class Solution {
    ...
    public static class TableAdapter implements ATable, BTable{
        ...
        public String getCurrentUserName()  { return "Amigo"; }

        public String getTableName() { return "DashboardTable"; }

        public String getHeaderText()  {
            String line = "["+ this.aTable.getCurrentUserName()+"]" + " : " + this.aTable.getTableName();
            return line; }
    }
