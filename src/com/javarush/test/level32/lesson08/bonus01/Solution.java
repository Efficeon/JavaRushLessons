...
public class Solution {
    ...
    public <T extends Item>T getProxy(Class<T> object, Class<?>...objects ){
        Class[] interfacesList = new Class[objects.length+1];
        System.arraycopy(objects, 0, interfacesList, 0, objects.length);
        interfacesList[interfacesList.length - 1] = object;
        return (T) Proxy.newProxyInstance(object.getClassLoader(), interfacesList, new ItemInvocationHandler());
    }
