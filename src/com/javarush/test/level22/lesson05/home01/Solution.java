...
public class Solution {
    ...
    public String getPartOfString(String string, String threadName) {
        ...
        try
        {
            ...
            newLine = string.substring(firstIndex+1, lastIndex);
            //newLine = newLine.substring()

        }
        catch (Exception t){
            if (threadName.equals(FIRST_THREAD_NAME)) throw new TooShortStringFirstThreadException(t);
            else if (threadName.equals(SECOND_THREAD_NAME))throw new TooShortStringSecondThreadException(t);
